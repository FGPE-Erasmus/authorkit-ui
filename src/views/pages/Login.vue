      ...
      <fgpe-card>
        <div slot="no-body" class="full-page-bg-color">
          <div class="vx-row">
            ...
            >
              <img
                src="@/assets/images/pages/authentication.png"
                alt="login"
                class="mx-auto"
              />
            </div>
            ...
            >
              <div class="p-8">
                ...
                <ValidationObserver v-slot="{ invalid }">
                  ...
                  <vs-divider>{{ $t("Login.DividerSocial") }}</vs-divider>
                  ...
                  <div class="social-login flex flex-wrap justify-center">
                    ...
                    >
                      ...
                      <!-- GITHUB -->
                      <div
                        class="bg-github pt-3 pb-2 px-4 rounded-lg cursor-pointer"
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      this.$store
        .dispatch(`${MODULE_BASE}/${AUTH_LOGIN}`, payload)
        .then(() => {
          this.$vs.notify({
