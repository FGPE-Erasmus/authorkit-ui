<template>
  <vs-prompt
    class="arguments-input-variable-dialog"
    :title="$t('ArgumentsInput.Popup.Title')"
      ...
      <div class="vx-col w-full mb-2">
        ...
        >
          <template slot="option" slot-scope="option">
            <div class="d-center">
              {{ $t("ArgumentsInput.Popup.Variables.Type." + option.label) }}
            </div>
          </template>
...
export default {
  name: "ArgumentsInputVariableDialog",
  components: {
    FgpeSelect,
    MultiRowInput
  },
