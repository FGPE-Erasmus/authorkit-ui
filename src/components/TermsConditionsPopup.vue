<template>
  <vs-popup
    :title="$t('TermsConditionsPopup.Title')"
  ...
  >
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to FGPE Consortium, Faculty of Economics and
          Management, Institute of IT in Management, University of Szczecin,
          Mickiewicza 64, Szczecin 71-101, Poland.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to FGPE AuthorKit, accessible from
          <a
            href="http://fgpe.dcc.fc.up.pt/"
            rel="external nofollow noopener"
            target="_blank"
            >http://fgpe.dcc.fc.up.pt/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: jakub.swacha@usz.edu.pl</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:
          <a
            href="http://fgpe.dcc.fc.up.pt/contact"
            rel="external nofollow noopener"
            target="_blank"
            >http://fgpe.dcc.fc.up.pt/contact</a
          >
        </p>
      </li>
    </ul>
